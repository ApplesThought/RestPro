 ...
 */
public class NoteLvAdapter extends BaseAdapter{

    private List<ReadNote> list;
    private Context context;
    private LayoutInflater inflater;

    public NoteLvAdapter(Context context, List<ReadNote> list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.lv_note_item,null);
